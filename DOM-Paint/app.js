...
document.querySelector('#inp-c').addEventListener("change", (event) => { 
...
document.querySelector('button').addEventListener("click", () => {
    document.getElementById("canvas").childNodes.forEach(x => x.style.backgroundColor = "#ffffff");
});

// make a new element that would save colors add another event listener to those dispatchEvent.

const saveBox = document.createElement("save");
